...
module.exports = () => {
    ...
    routerServicio.put('/updateByNumberTaxi/:idUnico', servicioController.updateNumberTaxi);
    routerServicio.put('/updateByWithValueNumberTaxi/:id/:idUnico', servicioController.updateWithValueNumberTaxi);
